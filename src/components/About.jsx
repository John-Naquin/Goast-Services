              ...
              <div className="relative">
                ...
                <div className="relative bg-white/80 backdrop-blur-sm p-6 rounded-lg border border-brandGold/10 shadow-md">
                  <p className="text-xl text-gray-700 leading-relaxed">
                    At <span className="font-semibold text-brandGold">Goast Services</span>, we specialize in delivering 
                    <span className="font-semibold"> tailored automation solutions</span> that transform how organizations operate.
                  </p>
                  <p className="text-gray-600 mt-4">
                    Our cutting-edge technologies and expert engineering team work together to create systems that optimize performance while reducing costs.
                  </p>
                </div>
              </div>
            </div>
  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white overflow-hidden">
      <div className="absolute inset-0 opacity-5">
        <div className="absolute inset-0 bg-gradient-to-br from-brandGold/10 to-transparent" />
        <div className="absolute right-0 bottom-0 w-3/4 h-3/4 bg-gradient-to-tl from-gray-100 to-transparent" />
      </div>
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <div className="aspect-w-4 aspect-h-3 lg:aspect-h-5">
              <img 
                src={image1} 
                alt="Goast Services automation solution in action" 
                className="object-cover w-full h-full transform transition-transform duration-700 group-hover:scale-105"
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8 flex justify-between">
              <p className="text-white text-lg sm:text-xl font-light italic">
                "Precision-engineered solutions for modern infrastructure"
              </p>
            </div>
            
            <div className="absolute top-6 right-6 w-20 h-20 border-t-4 border-r-4 border-brandGold/70 rounded-tr-2xl" />
            <div className="absolute bottom-6 left-6 w-20 h-20 border-b-4 border-l-4 border-brandGold/70 rounded-bl-2xl" />
          </motion.div>
          ...
          >
            ...
            <div className="space-y-5">
              <h3 className="text-xl font-bold text-gray-800">Our solutions empower you to:</h3>
              <motion.div
                className="grid grid-cols-1 sm:grid-cols-2 gap-4"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                {[
                  ...
                  <motion.div
                    key={i}
                    className="flex items-center p-4 bg-white border-l-4 border-brandGold rounded-lg shadow-sm hover:shadow-md transition-all duration-300"
                    initial={{ opacity: 0, y: 10 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                    transition={{ duration: 0.3, delay: i * 0.1 }}
            ...
            >
              <Link
                to="/services"
                className="group inline-flex items-center bg-brandGold hover:bg-brandGold/90 px-6 py-3 rounded-lg shadow-lg hover:shadow-brandGold/20 transition-all duration-300"
              >
                <span className="text-white font-semibold mr-2">
                  Explore Our Solutions
                </span>
