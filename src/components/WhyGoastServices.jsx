...
export function WhyGoastServices() {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-4 sm:px-8 lg:px-24 py-10 sm:py-14 md:py-16 bg-gray-100 bg-opacity-50 bg-[url('/subtle-pattern.png')] text-gray-800">
